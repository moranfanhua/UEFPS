...
void ABreachHUD::DrawSelection()
{
    ...
    Box(54,47,3,79,Cyan);
    MenuText(TEXT("UNDERTIDE  /  OPERATORS"),73,43,12,Cyan);
...
void ABreachHUD::DrawWeaponSelection()
{
    ...
    for(int32 I=0;I<Breach::WeaponCount;++I)
    {
        ...
        if(Ready) MenuText(I==0?TEXT("25 发 / 38 伤害"):I==1?TEXT("30 发 / 35 伤害"):
            I==2?TEXT("40 发 / 30 伤害"):TEXT("8 发 / 8×14 伤害"),X+13,Y+74,9,Muted,true);
